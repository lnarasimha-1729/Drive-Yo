...
export default function Dashboard() {
  ...
  return (
    <div className="p-8 sm:p-5 md:p-8 lg:py-10 bg-gray-50 min-h-screen">
      ...
      <p className="text-lg sm:text-2xl md:text-3xl lg:text-2xl font-semibold">
        Admin Dashboard
      </p>
      <Adminprofile/>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 xl:grid-cols-4 gap-3 sm:gap-5 mb-6">
        ...
        <div className="p-4 sm:p-5 bg-white rounded-lg shadow flex items-center justify-between">
          <div>
            <p className="text-lg sm:text-xl font-semibold">258</p>
            <p className="text-gray-600 text-xs sm:text-sm">Total Dealers</p>
          </div>
          <div className="bg-black w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-md">
            <img className="w-5 sm:w-6" src="https://img.icons8.com/pulsar-line/48/FFFFFF/cottage.png" />
          </div>
        </div>
        ...
        <div className="p-4 sm:p-5 bg-white rounded-lg shadow flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 text-xs sm:text-sm">Total Quotations</p>
          </div>
          <div className="bg-black w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-md">
            <img className="w-5 sm:w-6" src="https://img.icons8.com/fluency-systems-filled/48/FFFFFF/bill.png" />
          </div>
        </div>
        ...
        <div className="p-4 sm:p-5 bg-white rounded-lg shadow flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 text-xs sm:text-sm">Vehicles Leased</p>
          </div>
          <div className="bg-black w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-md">
            <img className="w-5 sm:w-6" src="https://img.icons8.com/ios-filled/50/FFFFFF/car.png" />
          </div>
        </div>
        ...
        <div className="p-4 sm:p-5 bg-white rounded-lg shadow flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 text-xs sm:text-sm">Active Zip Codes</p>
          </div>
          <div className="bg-black w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-md">
            <img className="w-5 sm:w-6" src="https://img.icons8.com/ios-filled/50/FFFFFF/marker.png" />
          </div>
        </div>
